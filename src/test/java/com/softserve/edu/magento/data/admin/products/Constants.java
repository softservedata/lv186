...
public class Constants {
	...
	public final static String NO_RECORD_FOUND = "We couldn't find any records.";
	...
	public static final String PRODUCT_ALREADY_EXISTS_MESSAGE = "URL key for specified store already exists.";
