...
public class AllCustomersPageAfterSuccesRegistration extends VerticalMenu {
	...
	public AllCustomersPageAfterSuccesRegistration(WebDriver driver) {
		...
		// driver.findElement(By.xpath(".//*[@id='idscheck20']"));
		// ////////////////////////////////////////////////////////////////////
		// CHANGE!!!!!!!!
	...
	public String getRegisteredNewCustomerLabelgetText() {
		return registeredNewCustomerLabel.getText().trim();
	}
	...
	// ------------------Yaryna Kharko update
		...
		public void deleteCustomerUser(ICustomerUser customerUser) throws InterruptedException {
			AllCustomersPageAfterSuccesRegistration CustomersPage = doCustomerSearch(customerUser.getPersonalInfo().getFullName());
