...
public class SearchImplicit extends ASearch {
    ...
    public SearchImplicit(BrowserRepository.BrowsersList) {
        super(application);
    ...
    @Override
    WebElement getVisibleWebElement(Find find) {
        WebElement result;
        BrowserRepository
    }

    @Override
    List<WebElement> getVisibleWebElements(Find find) {
        return null;
    }

    @Override
    WebElement getPresentWebElement(Find find) {
        return null;
    }
