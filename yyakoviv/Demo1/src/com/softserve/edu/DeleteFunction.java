...
public class DeleteFunction {
  ...
  public void DeleteWithoutCheking(BrowsersList browser) {
      ...
      Assert.assertEquals(driver.findElement(By.xpath("//p[@id='msgText']")).getText(), "Please select at least one comment");
  ...
  public void DeleteDismiss(BrowsersList browser) {
      ...
      driver.findElement(By.xpath("//div[@id='command-navigation']/*[4]")).click();
      Assert.assertEquals(driver.findElement(By.xpath("//p[@id='msgText']")).getText(), "Are you sure you want to delete the selected item(s)?");
  ...
  public void DeleteSomeAccept(BrowsersList browser) {
      ...
      driver.findElement(By.xpath("//td[text()='Comment Text 1']/preceding-sibling::td[2]")).click();
      driver.findElement(By.xpath("//td[text()='Comment Text 10']/preceding-sibling::td[2]")).click();
      ...
      while (!isWebElementFound2) {
          comments2 = driver.findElements(By.xpath("//td[contains(text(),'Comment Text 10')]"));
          if (comments2.size() > 0) {
      ...
      Assert.assertNotEquals(comment2.getText(), "Comment Text 10", "+++");
